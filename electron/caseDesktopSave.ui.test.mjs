...
assert(preload.includes('exportWorkbookToFile'), 'preload should expose workbook export with native save dialog')
assert(main.includes("ipcMain.handle('copper-case:save-desktop'"), 'main process should handle copper case export requests')
assert(main.includes("ipcMain.handle('export:save-workbook'"), 'main process should handle workbook export save requests')
