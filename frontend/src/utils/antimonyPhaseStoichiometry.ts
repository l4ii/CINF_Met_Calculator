...
export const ANTIMONY_BUILTIN_PHASE_FRACTIONS: Record<string, Partial<Record<string, number>>> = {
  Sb2S3: {
    'Sb(锑)': elementMassFraction({ Sb: 2, S: 3 }, 'Sb'),
    'S (硫)': elementMassFraction({ Sb: 2, S: 3 }, 'S'),
  },
  Cu2S: {
  ...
  As2S2: {
    'As(砷)': elementMassFraction({ As: 2, S: 2 }, 'As'),
    'S (硫)': elementMassFraction({ As: 2, S: 2 }, 'S'),
  },
  CaSiO3: {
...
export const ANTIMONY_PHASE_O2_FACTORS: Partial<Record<string, number>> = {
  Cu2O: ANTIMONY_BUILTIN_PHASE_FRACTIONS.Cu2O['O(氧)'] ?? 0,
  FeO: ANTIMONY_BUILTIN_PHASE_FRACTIONS.FeO['O(氧)'] ?? 0,
  Fe2O3: ANTIMONY_BUILTIN_PHASE_FRACTIONS.Fe2O3['O(氧)'] ?? 0,
  Fe3O4: ANTIMONY_BUILTIN_PHASE_FRACTIONS.Fe3O4['O(氧)'] ?? 0,
  PbO: ANTIMONY_BUILTIN_PHASE_FRACTIONS.PbO['O(氧)'] ?? 0,
  As2O3: ANTIMONY_BUILTIN_PHASE_FRACTIONS.As2O3['O(氧)'] ?? 0,
  Sb2O3: ANTIMONY_BUILTIN_PHASE_FRACTIONS.Sb2O3['O(氧)'] ?? 0,
  ZnO: ANTIMONY_BUILTIN_PHASE_FRACTIONS.ZnO['O(氧)'] ?? 0,
}

export const ANTIMONY_PHASE_SULFUR_FRACTIONS: Partial<Record<string, number>> = {
  Sb2S3: ANTIMONY_BUILTIN_PHASE_FRACTIONS.Sb2S3['S (硫)'] ?? 0,
  Cu2S: ANTIMONY_BUILTIN_PHASE_FRACTIONS.Cu2S['S (硫)'] ?? 0,
  FeS: ANTIMONY_BUILTIN_PHASE_FRACTIONS.FeS['S (硫)'] ?? 0,
  S: 1,
}

export {
  MM as ANTIMONY_PHASE_MOLAR_MASS,
  atomicMass,
  compoundMolarMass,
  elementMassFraction,
  ELEMENT_O_TO_O2,
