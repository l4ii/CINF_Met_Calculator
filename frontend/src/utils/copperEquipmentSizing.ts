import { calculateGasMixtureStandardVolumeNm3h } from './copperProductPhaseCalc.ts'
...
function processAirPhaseWeightPct(column: CopperMaterialColumn): Partial<Record<string, number>> {
  const oxygenAir = (column as CopperMaterialColumn & {
...
export function calculateProcessAirColumnVolumeNm3h(column: CopperMaterialColumn | null | undefined): number {
  if (!column) return 0
...
export function calculateOxygenColumnVolumeNm3h(column: CopperMaterialColumn | null | undefined): number {
