...
export type CopperHeatAuxiliaryTrace = {
...
export type CopperHeatAuxiliaryResult = {
  params: CopperHeatAuxiliaryParams
  trace: CopperHeatAuxiliaryTrace
}
...
function buildOxygenGasTrace(column: CopperMaterialColumn | undefined): OxygenEnrichmentGasTrace | null {
...
function buildOxygenTrace(airColumns: CopperMaterialColumn[] | undefined): Pick<
...
export function calculateCopperHeatAuxiliaryWithTrace(params: {
  ...
  const emptyParams: CopperHeatAuxiliaryParams = {
  ...
  const baseTrace: CopperHeatAuxiliaryTrace = {
  ...
  const trace: CopperHeatAuxiliaryTrace = {
    ...baseTrace,
    dustMassTh: dustMass,
...
export function calculateCopperHeatAuxiliaryParams(params: {
  ...
  return calculateCopperHeatAuxiliaryWithTrace(params).params
}
