...
function recalculateDeficitFromParts(next: AntimonyHeatBalanceResult) {
...
export function heatBalanceResidualMJh(result: AntimonyHeatBalanceResult): number {
...
export function hessHeatDeficitWithoutCoolingMJh(result: AntimonyHeatBalanceResult): number {
