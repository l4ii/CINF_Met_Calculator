...
import { elementSymbolLabel } from '../../utils/copperElementDisplay'
import { calculateKnownTotal, type CopperElementKey, type CopperRatios } from '../../utils/copperWorkflowCalc'
...
function productElementTotal(product: ProductElementTableProduct) {
  return calculateKnownTotal(product.composition as CopperRatios) + (product.composition['Other(其他)'] ?? 0)
}

export function CopperBatchProductElementTable({
  darkMode,
  elementKeys,
  products,
  nameColWidth,
