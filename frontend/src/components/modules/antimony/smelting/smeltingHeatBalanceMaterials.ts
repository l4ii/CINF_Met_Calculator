...
} from '../../../../utils/antimonyWorkflowCalc.ts'
...
export function buildSmeltingHeatBalanceSourceMaterials(
  ...
  const rawBlendMaterial: AntimonyHeatBalanceSourceMaterial | null =
    rawBlendDryWeight > 0 && blendPhaseMass && Object.keys(blendPhaseMass).length > 0
      ? {
          id: 'mixed-antimony-concentrate',
          name: '混合锑精矿',
          kind: 'raw',
